...
const HOTELS: HotelData[] = [
  {
    ...
    description:
      "One of Nellore's most popular hotels on MakeMyTrip, offering spacious AC rooms, a multi-cuisine restaurant, banquet facilities, and attentive service. Ideal for business and leisure travelers.",
  ...
  },
  {
    ...
    description:
      "A top-rated hotel on MakeMyTrip in Nellore, part of the ITC Fortune group. Features elegant rooms, a rooftop pool, multi-cuisine restaurant, and professional conference facilities.",
    address: "Gandhi Nagar, Nellore, Andhra Pradesh 524002",
    rating: 4.2,
    maxRating: 5,
    stars: 4,
    ...
    emoji: "🌟",
    image: "/assets/generated/hotel-fortune-select.dim_800x500.jpg",
    makemytripUrl:
      "https://www.makemytrip.com/hotels/fortune_select_grand_ridge-details-nellore.html",
  },
  {
    name: "Hotel Sai Balaji",
    category: "3-Star Comfort Hotel",
    description:
      "A well-reviewed hotel on MakeMyTrip with comfortable rooms, friendly service, and convenient access to Nellore railway station. Great value for families and budget-conscious business travelers.",
    ...
    emoji: "🏩",
    image: "/assets/generated/hotel-sai-balaji.dim_800x500.jpg",
    phone: "+91 861 230 5678",
    makemytripUrl:
      "https://www.makemytrip.com/hotels/hotel_sai_balaji-details-nellore.html",
  },
  {
    name: "Haritha Hotel (APTDC)",
    category: "Government Tourism Hotel",
    description:
      "Run by Andhra Pradesh Tourism Development Corporation, Haritha Hotel is a trusted and affordable option listed on MakeMyTrip. Clean rooms, pure vegetarian restaurant, and excellent connectivity to local sights.",
    address: "Trunk Road, Near Bus Stand, Nellore, Andhra Pradesh",
    rating: 3.2,
    maxRating: 5,
    stars: 3,
    priceRange: "₹800 – ₹1,800/night",
    amenities: ["Veg Restaurant", "Free WiFi", "AC Rooms", "Garden", "Parking"],
    emoji: "🌿",
    image: "/assets/generated/hotel-haritha-aptdc.dim_800x500.jpg",
    makemytripUrl:
      "https://www.makemytrip.com/hotels/haritha_hotel_aptdc-details-nellore.html",
  },
];
